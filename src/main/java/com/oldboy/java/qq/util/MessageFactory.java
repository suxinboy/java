...
public class MessageFactory {
	...
	public static BaseMessage parseClientMessageFromChannel(SocketChannel sc) throws Exception {
		...
		switch (msgType){
			...
			case BaseMessage.CLIENT_TO_SERVER_SHARE_SCREEN:
			{
				ServerChatsShareScreen msg = new ServerChatsShareScreen();

//				ImageIO.read()
//				msg.setBufferImageBytes(bufn.array());
				msg.setSendAddrBytes(QQUtil.getRemoteAddrBytes(sc.socket()));
				return msg;
			}
		}
		return null ;
...
//			case BaseMessage.SERVER_TO_CLIENT_SHARE_SCREEN:
//			{
//				in.read(bytes1);
//				int senderAddrLen = bytes1[0];
//				//读取发送地址
...
//				String msg = new String(bytesn);
//
//				ClientChatsShareScreen msg0 = new ClientChatsShareScreen ();
//				msg0.setImg;
//				msg0.setImg(senderAddrStr);
//				return msg0;
//			}
		}
		return null ;
